...
The projects include multimodal and agentic AI workflows using the OpenAI API, including image understanding, document processing, embeddings-based retrieval, and code interpreter execution. The system supports tasks such as visual parking lot analysis, PDF/image ingestion, semantic search with vector and BM25 retrieval, and automated CSV-based data analysis with plot generation, while exploring practical integration patterns for tool usage, file handling, and reasoning pipelines in modern LLM applications.
...
-    "interpretation": "The parking lot shows significant congestion, with vehicles parked irregularly, suggesting possible organization and safety concerns."
  },
  {
    "image": "Image 2",
+    "organization_score": 2,
-   "interpretation": "The parking lot shows minor congestion, with most spaces occupied but an overall organized layout."
  }
]
```
---

**7-Multimodal features: PDF processing:**
...
```
---
**8-Multimodal features: Excel file processing for data analysis and graph generation**
This project uses OpenAI’s Code Interpreter to perform automated CSV-based data analysis and visualization. The system uploads structured datasets, executes Python analysis dynamically, identifies meaningful relationships between variables, and generates plots programmatically. It demonstrates how LLMs can combine reasoning, coding, and file generation in an end-to-end analytical workflow.
In the following, you can observe a sample of graph generated by gpt-4o model.

![](agenticworkflow/multimodal/output/generated_plot.png)
